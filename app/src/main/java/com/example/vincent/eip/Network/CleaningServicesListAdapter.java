...
public class CleaningServicesListAdapter extends RecyclerView.Adapter<CleaningServicesListAdapter.MyViewHolder> {
    ...
    public CleaningServicesListAdapter(List<Serv> myDataset, OnSectorClick listener) {
        mDataset = myDataset;
        mListener = listener;
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.service_cleaning_list_item, parent, false);
